...
def acGenerate2DAnnualMeanMaps(t,annualMapsNcFile): 
    ...
    print ('Unic file for the ANNUAL MEAN x 33 years:', fy_dt)
...
def acGenerate2DSeasonalWinter(t,NCoutputWINTER):
    ...
    print("Reseized Area:",seasonal_data_winter)
    print("WINTER SEASON MINIMUM TEMPERATURE AT SEA SURFACE:", seasonal_data_winter.thetao.min())
    print("WINTER SEASON MAXIMUM TEMPERATURE AT SEA SURFACE:", seasonal_data_winter.thetao.max())

    print ('saving to ', NCoutputWINTER)
    seasonal_data_winter.to_netcdf(path=NCoutputWINTER)
    print ('finished saving')
...
def acGenerate2DSeasonalSummer(t,NCoutputSUMMER):
    ...
    print("Reseized Area:",seasonal_data_summer)
    print("SUMMER SEASON MINIMUM TEMPERATURE AT SEA SURFACE:", seasonal_data_summer.thetao.min())
    print("SUMMER SEASON MAXIMUM TEMPERATURE AT SEA SURFACE:", seasonal_data_summer.thetao.max())
